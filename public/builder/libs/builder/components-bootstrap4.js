...
Vvveb.Components.extend("_base", "html/container", {
    classes: ["container", "container-sm", "container-md", , "container-lg", "container-xl", "container-fluid"],
    image: "icons/container.svg",
    html: '<div class="container" style="min-height:150px;"><label>Container</label></div>',
    name: "Container",
    properties: [
     {
        name: "Type",
        ...
        htmlAttr: "class",
        inputtype: SelectInput,
        validValues: ["container", "container-sm", "container-md", , "container-lg", "container-xl", "container-fluid"],
        data: {
            options: [{
                value: "container",
                text: "Default"
...
Vvveb.Components.extend("_base", "html/image", {
    nodes: ["img"],
    name: "Image",
    html: '<img src="' +  asset_uri + '/libs/builder/icons/image.svg" height="128" width="128">',
    /*
...
Vvveb.Components.extend("_base", "html/buttons", {
...
Vvveb.Components.extend("_base", "html/video", {
    ...
    dragHtml: '<img  width="320" height="240" src="' + asset_uri + '/libs/builder/icons/video.svg">',
