...
@extends('layouts.vertical', ['title' => 'Rubrik'])
...
@section('content')
    ...
    <div class="container-fluid">
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Rubrik</li>
                        </ol>
                    </div>
        ...
        <div class="row ">
            <div class="col-sm-12">
                <form class="float-xl-right float-lg-right" method="GET" action="{{ route('rubrik.show') }}">
                    @method('GET')
                ...
                <form class="exe" method="POST" action="{{ route('rubrik.deletemass') }}">
                    @csrf
                    @method('POST')
                    <div class="form-row align-items-center">
                        <div class="col-auto">
                        ...
                        <tbody>
                            @foreach($lists as $key => $list)
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('rubrik.destroy', $list->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <a class="btn btn-success btn-sm" href="{{ route('rubrik.edit',$list->id) }}">Edit</a>
