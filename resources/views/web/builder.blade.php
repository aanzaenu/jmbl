...
<html lang="en">
  <head>
    ...
    <link href="{{ secure_asset('builder/css/editor.css') }}" rel="stylesheet">
...
<!-- builder code-->
<script src="{{ secure_asset('builder/libs/builder/builder.js?v=1.4') }}"></script>	
<!-- undo manager-->
<script src="{{ secure_asset('builder/libs/builder/undo.js') }}"></script>	
<!-- inputs-->
<script src="{{ secure_asset('builder/libs/builder/inputs.js?v=0.1') }}"></script>
...
<!-- components-->
<script src="{{ secure_asset('builder/libs/builder/components-bootstrap4.js?v=1.2') }}"></script>	
