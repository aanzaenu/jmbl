...
<html lang="en">
  <head>
    ...
    <link href="{{ secure_asset('builder2/css/editor.css') }}" rel="stylesheet">
    <link href="{{ secure_asset('builder2/css/line-awesome.css') }}" rel="stylesheet">
	<link href="{{ secure_asset('builder2/libs/bootstrap-colorpicker/css/bootstrap-colorpicker.min.css') }}" rel="stylesheet">
	<link href="{{ secure_asset('builder2/libs/codemirror/lib/codemirror.css') }}" rel="stylesheet"/>
	<link href="{{ secure_asset('builder2/libs/codemirror/theme/material.css') }}" rel="stylesheet"/>
  </head>
<body>
				...
				<div id="top-panel">
					...
					<div class="btn-group float-left" role="group">
					  <button class="btn btn-light" title="Toggle file manager" id="toggle-file-manager-btn" data-vvveb-action="toggleFileManager" data-toggle="button" aria-pressed="false">
						  <img src="{{ secure_asset('builder/libs/builder/icons/file-manager-layout.svg') }}" width="20px" height="20px">
					  </button>
					  ...
					  <button class="btn btn-light" title="Toggle left column" id="toggle-left-column-btn" data-vvveb-action="toggleLeftColumn" data-toggle="button" aria-pressed="false">
						  <img src="{{ secure_asset('builder/libs/builder/icons/left-column-layout.svg') }}" width="20px" height="20px">
					  </button>
					  ...
					  <button class="btn btn-light" title="Toggle right column" id="toggle-right-column-btn" data-vvveb-action="toggleRightColumn" data-toggle="button" aria-pressed="false">
						  <img src="{{ secure_asset('builder/libs/builder/icons/right-column-layout.svg') }}" width="20px" height="20px">
					  </button>
					</div>
					...
					<div class="btn-group mr-3" role="group">
					  ...
					  <button class="btn btn-light" title="Edit Detail" data-toggle="modal" data-target="#exampleModal">
					  ...
					  <div id="filemanager"> 
							<div class="header">
								<a href="#" class="text-secondary">Pages</a>
									...
									<div class="btn-group responsive-btns mr-4 float-right d-none" role="group">
...
<!-- jquery-->
<script src="{{ secure_asset('builder2/js/jquery.min.js') }}"></script>
<script src="{{ secure_asset('builder2/js/jquery.hotkeys.js') }}"></script>

<!-- bootstrap-->
<script src="{{ secure_asset('builder2/js/popper.min.js') }}"></script>
<script src="{{ secure_asset('builder2/js/bootstrap.min.js') }}"></script>

<!-- builder code-->
<script src="{{ secure_asset('builder2/libs/builder/builder.js?v=1.4') }}"></script>	
<!-- undo manager-->
<script src="{{ secure_asset('builder2/libs/builder/undo.js') }}"></script>	
<!-- inputs-->
<script src="{{ secure_asset('builder2/libs/builder/inputs.js?v=0.1') }}"></script>

<script src="{{ secure_asset('builder2/libs/bootstrap-colorpicker/js/bootstrap-colorpicker.min.js') }}"></script>
<script src="{{ secure_asset('builder2/libs/builder/plugin-bootstrap-colorpicker.js') }}"></script>

<!-- components-->
<script src="{{ secure_asset('builder2/libs/builder/components-bootstrap4.js?v=0.9') }}"></script>	
<script src="{{ secure_asset('builder2/libs/builder/components-widgets.js') }}"></script>	
...
<script src="{{ secure_asset('builder2/libs/codemirror/lib/codemirror.js') }}"></script>
<script src="{{ secure_asset('builder2/libs/codemirror/lib/xml.js') }}"></script>
<script src="{{ secure_asset('builder2/libs/codemirror/lib/formatting.js') }}"></script>
<script src="{{ secure_asset('builder2/libs/builder/plugin-codemirror.js') }}"></script>	
...
<script src="{{ secure_asset('builder2/libs/autocomplete/jquery.autocomplete.js') }}"></script>	

<script>
$(document).ready(function() 
{
	$('.modalpertama').modal('show');
	...
	[
		{name:"narrow-jumbotron", title:"Jumbotron",  url: "{{ secure_asset('builder/demo/narrow-jumbotron/index.html') }}", assets: ["{{ secure_asset('builder/demo/narrow-jumbotron/narrow-jumbotron.css') }}"]},
		{name:"album", title:"Album",  url: "{{ secure_asset('builder/demo/album/index.html') }}", folder:"content", assets: ["{{ secure_asset('builder/demo/album/album.css') }}"]},
		{name:"blog", title:"Blog",  url: "{{ secure_asset('builder/demo/blog/index.html') }}", folder:"content", assets: ["{{ secure_asset('builder/demo/blog/blog.css') }}"]},
		{name:"carousel", title:"Carousel",  url: "{{ secure_asset('builder/demo/carousel/index.html') }}", folder:"content", assets: ["{{ secure_asset('builder/demo/carousel/carousel.css') }}"]},
		{name:"offcanvas", title:"Offcanvas",  url: "{{ secure_asset('builder/demo/offcanvas/index.html') }}", folder:"content", assets: ["{{ secure_asset('builder/demo/offcanvas/offcanvas.css') }}","{{ secure_asset('builder/demo/offcanvas/offcanvas.js') }}"]},
		{name:"pricing", title:"Pricing",  url: "{{ secure_asset('builder/demo/pricing/index.html') }}", folder:"ecommerce", assets: ["{{ secure_asset('builder/demo/pricing/pricing.css') }}"]},
		{name:"product", title:"Product",  url: "{{ secure_asset('builder/demo/product/index.html') }}", folder:"ecommerce", assets: ["{{ secure_asset('builder/demo/product/product.css') }}"]},
		...
		?>
	Vvveb.Builder.init('about:blank', function() {
		Vvveb.Builder.setHtml('<h1>test</h1>');
	});
	...
	$('.modalpertama').click('button.tutup', function(){
		console.log(13);
		$('.modalpertama').modal('hide');
	})
});
function ambildata(callback, datas)
{
	$.ajax({
		type: "POST",
		url: 'save.php',
...
function uploadgambar(event, formData)
{
